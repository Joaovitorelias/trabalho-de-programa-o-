...
const perguntas = [
    {
        enunciado: "Como lidar de forma aceitavel com o cancer",
        alternativas: [
            {
                texto: "A saúde mental e emocional durante o tratamento de câncer é a capacidade de enfrentar os desafios diários do tratamento de forma equilibrada, mantendo a resiliência frente ás dificiuldades físicas e emocionais que surgem nesse processo.",
